    ...
    return {
        ...
        */
        ...
        iterate: function(count) {
        	var result = function($context, object, fieldArray, callback) {
        		var selector = '*[data-role="iterator"]';
        		...
        		for(var i=0;i<count;i++) {
        			_contextParse(elementToRepeat.clone().appendTo(parent), object[i], fieldArray); 
        		}
        	}; 
